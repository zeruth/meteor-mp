...
@OriginalClass("client.client!ib")
public class Pix8 extends Pix2D {

	@OriginalMember(owner = "client.client!ib", name = "z", descriptor = "[B")
	public byte[] pixels;

	@OriginalMember(owner = "client.client!ib", name = "A", descriptor = "[I")
	public final int[] palette;

	@OriginalMember(owner = "client.client!ib", name = "B", descriptor = "I")
	public int width;

	@OriginalMember(owner = "client.client!ib", name = "C", descriptor = "I")
	public int height;

	@OriginalMember(owner = "client.client!ib", name = "D", descriptor = "I")
	public int cropX;

	@OriginalMember(owner = "client.client!ib", name = "E", descriptor = "I")
	public int cropY;

	@OriginalMember(owner = "client.client!ib", name = "F", descriptor = "I")
	public int cropW;

	@OriginalMember(owner = "client.client!ib", name = "G", descriptor = "I")
	private int cropH;

	@OriginalMember(owner = "client.client!ib", name = "<init>", descriptor = "(Lclient!ub;Ljava/lang/String;I)V")
	...
	@OriginalMember(owner = "client.client!ib", name = "a", descriptor = "(Z)V")
	public void shrink() {
		this.cropW /= 2;
		this.cropH /= 2;
	...
	@OriginalMember(owner = "client.client!ib", name = "c", descriptor = "(I)V")
	public void crop() {
	...
	@OriginalMember(owner = "client.client!ib", name = "d", descriptor = "(I)V")
	...
	@OriginalMember(owner = "client.client!ib", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "client.client!ib", name = "a", descriptor = "(IIIZ)V")
	...
	@OriginalMember(owner = "client.client!ib", name = "a", descriptor = "(IIZ)V")
	...
	@OriginalMember(owner = "client.client!ib", name = "a", descriptor = "([III[BIIIII[I)V")
