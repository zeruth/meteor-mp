...
public class AnimBase {
	...
	@OriginalMember(owner = "client.client!f", name = "a", descriptor = "[Lclient!f;")
	public static AnimBase[] instances;

	@OriginalMember(owner = "client.client!f", name = "b", descriptor = "I")
	public int length;

	// an operation for a specific group - [group]
	@OriginalMember(owner = "client.client!f", name = "c", descriptor = "[I")
	public int[] types;

	// labels for a specific group - [group] [label]
	@OriginalMember(owner = "client.client!f", name = "d", descriptor = "[[I")
	public int[][] labels;

	@OriginalMember(owner = "client.client!f", name = "a", descriptor = "(ZLclient!ub;)V")
