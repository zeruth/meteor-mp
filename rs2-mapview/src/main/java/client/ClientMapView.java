...
public class ClientMapView extends GameShellMapView {
	public static ClientMapView clientMapView;
	...
	@OriginalMember(owner = "client", name = "X", descriptor = "Lclient!kb;")
	...
	@OriginalMember(owner = "client", name = "gb", descriptor = "Lclient!ob;")
	private LinkList locList = new LinkList();

	@OriginalMember(owner = "client", name = "hb", descriptor = "Lclient!tb;")
	...
	@OriginalMember(owner = "client", name = "vb", descriptor = "Lclient!ob;")
	...
	@OriginalMember(owner = "client", name = "Eb", descriptor = "[Lclient!hb;")
	private Pix32MapView[] imageHitmarks = new Pix32MapView[20];
	...
	@OriginalMember(owner = "client", name = "Tb", descriptor = "[Lclient!hb;")
	private Pix32MapView[] activeMapFunctions = new Pix32MapView[1000];
	...
	@OriginalMember(owner = "client", name = "Xb", descriptor = "Lclient!kb;")
	private Packet in = Packet.alloc(1);

	@OriginalMember(owner = "client", name = "Zb", descriptor = "I")
	public static int oplogic4;

	@OriginalMember(owner = "client", name = "ac", descriptor = "Lclient!kb;")
	...
	@OriginalMember(owner = "client", name = "kc", descriptor = "Lclient!hc;")
	private final ComponentMapView chatInterface = new ComponentMapView();
	...
	@OriginalMember(owner = "client", name = "qc", descriptor = "[Lclient!ib;")
	private Pix8MapView[] imageSideicons = new Pix8MapView[13];
	...
	@OriginalMember(owner = "client", name = "yc", descriptor = "[Lclient!z;")
	...
	@OriginalMember(owner = "client", name = "Dc", descriptor = "[Lclient!kb;")
	...
	@OriginalMember(owner = "client", name = "Hc", descriptor = "Lclient!r;")
	private World3D scene;

	@OriginalMember(owner = "client", name = "Ic", descriptor = "Lclient!ob;")
	...
	@OriginalMember(owner = "client", name = "cd", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackbase1;

	@OriginalMember(owner = "client", name = "dd", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackbase2;

	@OriginalMember(owner = "client", name = "ed", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackhmid1;
	...
	@OriginalMember(owner = "client", name = "Id", descriptor = "Lclient!ob;")
	...
	@OriginalMember(owner = "client", name = "Pd", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone1;

	@OriginalMember(owner = "client", name = "Qd", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone2;

	@OriginalMember(owner = "client", name = "Rd", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone3;

	@OriginalMember(owner = "client", name = "Sd", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone1h;

	@OriginalMember(owner = "client", name = "Td", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone2h;
	...
	@OriginalMember(owner = "client", name = "ge", descriptor = "Lclient!ib;")
	private Pix8MapView imageBackbase1;

	@OriginalMember(owner = "client", name = "he", descriptor = "Lclient!ib;")
	private Pix8MapView imageBackbase2;

	@OriginalMember(owner = "client", name = "ie", descriptor = "Lclient!ib;")
	private Pix8MapView imageBackhmid1;
	...
	@OriginalMember(owner = "client", name = "ze", descriptor = "[Lclient!y;")
	...
	@OriginalMember(owner = "client", name = "af", descriptor = "[Lclient!ec;")
	private CollisionMap[] levelCollisionMap = new CollisionMap[4];

	@OriginalMember(owner = "client", name = "bf", descriptor = "I")
	public static int loopCycle;

	@OriginalMember(owner = "client", name = "cf", descriptor = "[Lclient!hb;")
	private Pix32MapView[] imageHeadicons = new Pix32MapView[20];
	...
	@OriginalMember(owner = "client", name = "hf", descriptor = "Lclient!hb;")
	private Pix32MapView genderButtonImage0;

	@OriginalMember(owner = "client", name = "jf", descriptor = "Lclient!hb;")
	private Pix32MapView genderButtonImage1;
	...
	@OriginalMember(owner = "client", name = "of", descriptor = "Lclient!z;")
	...
	@OriginalMember(owner = "client", name = "uf", descriptor = "[Lclient!ib;")
	private Pix8MapView[] imageRunes;
	...
	@OriginalMember(owner = "client", name = "zf", descriptor = "Lclient!hb;")
	private Pix32MapView imageFlamesLeft;

	@OriginalMember(owner = "client", name = "Af", descriptor = "Lclient!hb;")
	private Pix32MapView imageFlamesRight;

	@OriginalMember(owner = "client", name = "Bf", descriptor = "I")
	private final int SCROLLBAR_GRIP_LOWLIGHT = 0x332d25;

	@OriginalMember(owner = "client", name = "Cf", descriptor = "Lclient!ib;")
	private Pix8MapView imageInvback;

	@OriginalMember(owner = "client", name = "Df", descriptor = "Lclient!ib;")
	private Pix8MapView imageMapback;

	@OriginalMember(owner = "client", name = "Ef", descriptor = "Lclient!ib;")
	private Pix8MapView imageChatback;

	@OriginalMember(owner = "client", name = "Ff", descriptor = "I")
	private int inMultizone;

	@OriginalMember(owner = "client", name = "Gf", descriptor = "Lclient!jb;")
	private PixFontMapView fontPlain11;

	@OriginalMember(owner = "client", name = "Hf", descriptor = "Lclient!jb;")
	private PixFontMapView fontPlain12;

	@OriginalMember(owner = "client", name = "If", descriptor = "Lclient!jb;")
	private PixFontMapView fontBold12;

	@OriginalMember(owner = "client", name = "Jf", descriptor = "Lclient!jb;")
	...
	@OriginalMember(owner = "client", name = "Sf", descriptor = "Lclient!hb;")
	private Pix32MapView imageMapflag;

	@OriginalMember(owner = "client", name = "Tf", descriptor = "I")
	public static int cyclelogic3;

	@OriginalMember(owner = "client", name = "Uf", descriptor = "Lclient!d;")
	private ClientStreamMapView stream;
	...
	@OriginalMember(owner = "client", name = "cg", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackleft1;

	@OriginalMember(owner = "client", name = "dg", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackleft2;

	@OriginalMember(owner = "client", name = "eg", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackright1;

	@OriginalMember(owner = "client", name = "fg", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackright2;

	@OriginalMember(owner = "client", name = "gg", descriptor = "Lclient!qb;")
	private PixMapMapView areaBacktop1;

	@OriginalMember(owner = "client", name = "hg", descriptor = "Lclient!qb;")
	private PixMapMapView areaBacktop2;

	@OriginalMember(owner = "client", name = "ig", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackvmid1;

	@OriginalMember(owner = "client", name = "jg", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackvmid2;

	@OriginalMember(owner = "client", name = "kg", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackvmid3;

	@OriginalMember(owner = "client", name = "lg", descriptor = "Lclient!qb;")
	private PixMapMapView areaBackhmid2;
	...
	@OriginalMember(owner = "client", name = "yg", descriptor = "Lclient!qb;")
	private PixMapMapView imageTitle2;

	@OriginalMember(owner = "client", name = "zg", descriptor = "Lclient!qb;")
	private PixMapMapView imageTitle3;

	@OriginalMember(owner = "client", name = "Ag", descriptor = "Lclient!qb;")
	private PixMapMapView imageTitle4;

	@OriginalMember(owner = "client", name = "Bg", descriptor = "Lclient!qb;")
	private PixMapMapView imageTitle0;

	@OriginalMember(owner = "client", name = "Cg", descriptor = "Lclient!qb;")
	private PixMapMapView imageTitle1;

	@OriginalMember(owner = "client", name = "Dg", descriptor = "Lclient!qb;")
	private PixMapMapView imageTitle5;

	@OriginalMember(owner = "client", name = "Eg", descriptor = "Lclient!qb;")
	private PixMapMapView imageTitle6;

	@OriginalMember(owner = "client", name = "Fg", descriptor = "Lclient!qb;")
	private PixMapMapView imageTitle7;

	@OriginalMember(owner = "client", name = "Gg", descriptor = "Lclient!qb;")
	private PixMapMapView imageTitle8;

	@OriginalMember(owner = "client", name = "Hg", descriptor = "[Lclient!ib;")
	private Pix8MapView[] imageMapscene = new Pix8MapView[50];

	@OriginalMember(owner = "client", name = "Jg", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone1v;

	@OriginalMember(owner = "client", name = "Kg", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone2v;

	@OriginalMember(owner = "client", name = "Lg", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone3v;

	@OriginalMember(owner = "client", name = "Mg", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone1hv;

	@OriginalMember(owner = "client", name = "Ng", descriptor = "Lclient!ib;")
	private Pix8MapView imageRedstone2hv;

	@OriginalMember(owner = "client", name = "Og", descriptor = "[I")
	private final int[] CHAT_COLORS = new int[] { 16776960, 16711680, 65280, 65535, 16711935, 16777215 };

	@OriginalMember(owner = "client", name = "Pg", descriptor = "Lclient!qb;")
	private PixMapMapView areaSidebar;

	@OriginalMember(owner = "client", name = "Qg", descriptor = "Lclient!qb;")
	private PixMapMapView areaMapback;

	@OriginalMember(owner = "client", name = "Rg", descriptor = "Lclient!qb;")
	public PixMapMapView areaViewport;

	@OriginalMember(owner = "client", name = "Sg", descriptor = "Lclient!qb;")
	private PixMapMapView areaChatback;
	...
	@OriginalMember(owner = "client", name = "Wg", descriptor = "Lclient!hb;")
	private Pix32MapView imageMinimap;
	...
	@OriginalMember(owner = "client", name = "Zg", descriptor = "Lclient!ob;")
	private LinkList spotanims = new LinkList();

	@OriginalMember(owner = "client", name = "ah", descriptor = "Lclient!hb;")
	private Pix32MapView imageMapdot0;

	@OriginalMember(owner = "client", name = "bh", descriptor = "Lclient!hb;")
	private Pix32MapView imageMapdot1;

	@OriginalMember(owner = "client", name = "ch", descriptor = "Lclient!hb;")
	private Pix32MapView imageMapdot2;

	@OriginalMember(owner = "client", name = "dh", descriptor = "Lclient!hb;")
	...
	@OriginalMember(owner = "client", name = "yh", descriptor = "Lclient!ib;")
	private Pix8MapView imageScrollbar0;

	@OriginalMember(owner = "client", name = "zh", descriptor = "Lclient!ib;")
	private Pix8MapView imageScrollbar1;
	...
	@OriginalMember(owner = "client", name = "Uh", descriptor = "Lclient!ib;")
	private Pix8MapView imageTitlebox;

	@OriginalMember(owner = "client", name = "Vh", descriptor = "Lclient!ib;")
	private Pix8MapView imageTitlebutton;
	...
	@OriginalMember(owner = "client", name = "li", descriptor = "[Lclient!hb;")
	private Pix32MapView[] imageCrosses = new Pix32MapView[8];
	...
	@OriginalMember(owner = "client", name = "Ki", descriptor = "Lclient!hb;")
	private Pix32MapView imageCompass;
	...
	@OriginalMember(owner = "client", name = "Wi", descriptor = "[[[Lclient!ob;")
	...
	public static void main(@OriginalArg(0) String[] args) {
		try {
			System.out.println("RS2 user client.client - release #" + signlinkMapView.clientversion);
			...
			if (vendor.toLowerCase().indexOf("sun") != -1 || vendor.toLowerCase().indexOf("apple") != -1) {
				signlinkMapView.sunjava = true;
			}

			signlinkMapView.startpriv(InetAddress.getByName("localhost"));

			@Pc(82) ClientMapView c = new ClientMapView();
		...
		for (@Pc(15) int index = -1; index < this.playerCount + this.npcCount; index++) {
			...
			if (entity.combatCycle > loopCycle + 100) {
				...
				if (this.projectX > -1) {
					...
					Pix2DMapView.fillRect(this.projectX - 15, this.projectY - 3, 0xff00, w, 5);
					Pix2DMapView.fillRect(this.projectX - 15 + w, this.projectY - 3, 0xff0000, 30 - w, 5);
				}
			}
		...
		for (@Pc(483) int i = 0; i < this.chatCount; i++) {
			...
			if (this.chatEffects == 0) {
				...
				if (this.chatStyles[i] == 2) {
					...
					Pix2DMapView.setClipping(334, this.projectX + 50, 0, this.projectX - 50);
	...
	private void stopMidi() {
		signlinkMapView.midifade = 0;
		signlinkMapView.midi = "stop";
	...
	private void drawPrivateMessages() {
		...
		@Pc(9) PixFontMapView font = this.fontPlain12;
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Lclient!kb;II)V")
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(BLclient!kb;I)V")
	...
	private void runMidi() {
		...
		while (this.midiThreadActive) {
			...
			if (name != null) {
				@Pc(52) byte[] data = signlinkMapView.cacheload(name + ".mid");
				@Pc(69) int dataCrc;
				...
				if (data == null) {
					try {
						...
						stream.close();
						signlinkMapView.cachesave(name + ".mid", data);
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(IIILclient!hc;III)V")
	private void handleInterfaceInput(@OriginalArg(3) ComponentMapView com, @OriginalArg(1) int mouseX, @OriginalArg(0) int mouseY, @OriginalArg(5) int x, @OriginalArg(2) int y, @OriginalArg(6) int scrollPosition) {
		...
		for (@Pc(44) int i = 0; i < children; i++) {
			...
			@Pc(69) ComponentMapView child = ComponentMapView.instances[com.childId[i]];
			...
			if (child.type == 0) {
				...
				for (@Pc(490) int row = 0; row < child.height; row++) {
					for (@Pc(494) int col = 0; col < child.width; col++) {
						...
						@Pc(567) ObjTypeMapView obj = ObjTypeMapView.get(child.invSlotObjId[slot] - 1);
				...
				if (child.buttonType == ComponentMapView.BUTTON_OK) {
				...
				} else if (child.buttonType == ComponentMapView.BUTTON_TARGET && this.spellSelected == 0) {
					...
					this.menuParamC[this.menuSize] = child.id;
					this.menuSize++;
				} else if (child.buttonType == ComponentMapView.BUTTON_CLOSE) {
					this.menuOption[this.menuSize] = "Close";
					this.menuAction[this.menuSize] = 947;
					this.menuParamC[this.menuSize] = child.id;
					this.menuSize++;
				} else if (child.buttonType == ComponentMapView.BUTTON_TOGGLE) {
					this.menuOption[this.menuSize] = child.option;
					this.menuAction[this.menuSize] = 465;
					this.menuParamC[this.menuSize] = child.id;
					this.menuSize++;
				} else if (child.buttonType == ComponentMapView.BUTTON_SELECT) {
					this.menuOption[this.menuSize] = child.option;
					this.menuAction[this.menuSize] = 960;
					this.menuParamC[this.menuSize] = child.id;
					this.menuSize++;
				} else if (child.buttonType == ComponentMapView.BUTTON_CONTINUE && !this.pressedContinueOption) {
					this.menuOption[this.menuSize] = child.option;
	...
	private void handleChatSettingsInput() {
		...
		if (super.mouseClickX >= 8 && super.mouseClickX <= 108 && super.mouseClickY >= 490 && super.mouseClickY <= 522) {
			...
			for (@Pc(186) int i = 0; i < ComponentMapView.instances.length; i++) {
				if (ComponentMapView.instances[i] != null && ComponentMapView.instances[i].clientCode == 600) {
					this.reportAbuseInterfaceID = this.viewportInterfaceId = ComponentMapView.instances[i].layer;
					return;
				}
			}
		}
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Lclient!bc;IIII)V")
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;II)Lclient!ub;")
	private Jagfile loadArchive(@OriginalArg(2) String name, @OriginalArg(1) int crc, @OriginalArg(0) String displayName, @OriginalArg(3) int displayProgress) {
		@Pc(3) int retry = 5;
		@Pc(6) byte[] data = signlinkMapView.cacheload(name);
		if (data != null) {
			this.crc32.reset();
			this.crc32.update(data);
	...
	private void updateTextures(@OriginalArg(0) int cycle) {
		if (!lowMemory) {
			if (Pix3DMapView.textureCycle[17] >= cycle) {
				Pix8MapView texture = Pix3DMapView.textures[17];
				...
				Pix3DMapView.pushTexture(17);
			}

			if (Pix3DMapView.textureCycle[24] >= cycle) {
				Pix8MapView texture = Pix3DMapView.textures[24];
				int bottom = texture.width * texture.height - 1;
				int adjustment = texture.width * this.sceneDelta * 2;
	...
	private void drawMinimap() {
		...
		Pix2DMapView.fillRect(93, 82, 0xffffff, 3, 3);
	...
	public java.awt.Component getBaseComponent() {
		if (signlinkMapView.mainapp != null) {
			return signlinkMapView.mainapp;
		}
	...
	private void drawMinimapLoc(@OriginalArg(3) int tileX, @OriginalArg(5) int tileZ, @OriginalArg(1) int level, @OriginalArg(2) int wallRgb, @OriginalArg(4) int doorRgb) {
		...
		if (bitset != 0) {
			...
			if (loc.mapscene == -1) {
				...
				@Pc(71) Pix8MapView scene = this.imageMapscene[loc.mapscene];
				if (scene != null) {
		...
		if (bitset != 0) {
			...
			if (loc.mapscene != -1) {
				@Pc(461) Pix8MapView scene = this.imageMapscene[loc.mapscene];
				if (scene != null) {
		...
		if (bitset != 0) {
			...
			if (loc.mapscene != -1) {
				@Pc(625) Pix8MapView scene = this.imageMapscene[loc.mapscene];
				if (scene != null) {
					int offsetX = (loc.width * 4 - scene.width) / 2;
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Lclient!kb;IZ)V")
	private void getNpcPos(@OriginalArg(0) Packet buf, @OriginalArg(1) int size) {
		...
		if (buf.pos != size) {
			signlinkMapView.reporterror(this.username + " size mismatch in getnpcpos - pos:" + buf.pos + " psize:" + size);
			throw new RuntimeException("eek");
		}

		for (int i = 0; i < this.npcCount; i++) {
			if (this.npcs[this.npcIds[i]] == null) {
				signlinkMapView.reporterror(this.username + " null entry in npc list - pos:" + i + " size:" + this.npcCount);
				throw new RuntimeException("eek");
			}
		}
	}
	...
	public void startThread(@OriginalArg(0) Runnable runnable, @OriginalArg(1) int priority) {
		if (signlinkMapView.mainapp != null) {
			signlinkMapView.startthread(runnable, priority);
		} else {
	...
	private void loadTitleImages() {
		this.imageTitlebox = new Pix8MapView(this.archiveTitle, "titlebox", 0);
		this.imageTitlebutton = new Pix8MapView(this.archiveTitle, "titlebutton", 0);
		this.imageRunes = new Pix8MapView[12];
		for (@Pc(32) int i = 0; i < 12; i++) {
			this.imageRunes[i] = new Pix8MapView(this.archiveTitle, "runes", i);
		}
		this.imageFlamesLeft = new Pix32MapView(128, 265);
		this.imageFlamesRight = new Pix32MapView(128, 265);
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(ILclient!kb;I)V")
	private void getPlayerOldVis(@OriginalArg(1) Packet buf, @OriginalArg(0) int size) {
		...
		if (count > this.playerCount) {
			signlinkMapView.reporterror(this.username + " Too many players");
			throw new RuntimeException("eek");
		}
	...
	private void drawScrollbar(@OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int scrollY, @OriginalArg(4) int scrollHeight, @OriginalArg(5) int height) {
		...
		Pix2DMapView.fillRect(x, y + 16, this.SCROLLBAR_TRACK, 16, height - 32);
		...
		Pix2DMapView.fillRect(x, y + gripY + 16, this.SCROLLBAR_GRIP_FOREGROUND, 16, gripSize);

		Pix2DMapView.vline(x, y + gripY + 16, this.SCROLLBAR_GRIP_HIGHLIGHT, gripSize);
		Pix2DMapView.vline(x + 1, y + gripY + 16, this.SCROLLBAR_GRIP_HIGHLIGHT, gripSize);

		Pix2DMapView.hline(x, y + gripY + 16, this.SCROLLBAR_GRIP_HIGHLIGHT, 16);
		Pix2DMapView.hline(x, y + gripY + 17, this.SCROLLBAR_GRIP_HIGHLIGHT, 16);

		Pix2DMapView.vline(x + 15, y + gripY + 16, this.SCROLLBAR_GRIP_LOWLIGHT, gripSize);
		Pix2DMapView.vline(x + 14, y + gripY + 17, this.SCROLLBAR_GRIP_LOWLIGHT, gripSize - 1);

		Pix2DMapView.hline(x, y + gripY + gripSize + 15, this.SCROLLBAR_GRIP_LOWLIGHT, 16);
		Pix2DMapView.hline(x + 1, y + gripY + gripSize + 14, this.SCROLLBAR_GRIP_LOWLIGHT, 15);
	}
	...
	private void saveMidi(@OriginalArg(0) byte[] src, @OriginalArg(2) int length, @OriginalArg(3) int fade) {
		signlinkMapView.midifade = fade;
		signlinkMapView.midisave(src, length);
	}
	...
	private void setMidiVolume(@OriginalArg(1) int volume) {
		signlinkMapView.midivol = volume;
		signlinkMapView.midi = "voladjust";
	}
	...
	private void prepareGameScreen() {
		...
		this.areaChatback = new PixMapMapView(this.getBaseComponent(), 479, 96);
		this.areaMapback = new PixMapMapView(this.getBaseComponent(), 168, 160);
		Pix2DMapView.clear();
		this.imageMapback.draw(0, 0);
		this.areaSidebar = new PixMapMapView(this.getBaseComponent(), 190, 261);
		this.areaViewport = new PixMapMapView(this.getBaseComponent(), 512, 334);
		Pix2DMapView.clear();
		this.areaBackbase1 = new PixMapMapView(this.getBaseComponent(), 501, 61);
		this.areaBackbase2 = new PixMapMapView(this.getBaseComponent(), 288, 40);
		this.areaBackhmid1 = new PixMapMapView(this.getBaseComponent(), 269, 66);
		this.redrawBackground = true;
	}

	@OriginalMember(owner = "client", name = "a", descriptor = "(IILclient!kb;)V")
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(IIILclient!hc;I)V")
	private void drawInterface(@OriginalArg(3) ComponentMapView com, @OriginalArg(1) int x, @OriginalArg(0) int y, @OriginalArg(4) int scrollY) {
		...
		@Pc(29) int left = Pix2DMapView.boundLeft;
		@Pc(31) int top = Pix2DMapView.boundTop;
		@Pc(33) int right = Pix2DMapView.boundRight;
		@Pc(35) int bottom = Pix2DMapView.boundBottom;

		Pix2DMapView.setClipping(y + com.height, x + com.width, y, x);
		...
		for (@Pc(59) int i = 0; i < children; i++) {
			...
			@Pc(84) ComponentMapView child = ComponentMapView.instances[com.childId[i]];
			childX += child.x;
			childY += child.y;
			...
			if (child.type == 0) {
					...
					for (int col = 0; col < child.width; col++) {
						...
						if (child.invSlotObjId[slot] > 0) {
							...
							if (slotX >= -32 && slotX <= 512 && slotY >= -32 && slotY <= 334 || this.objDragArea != 0 && this.objDragSlot == slot) {
								@Pc(251) Pix32MapView icon = ObjTypeMapView.getIcon(id, child.invSlotObjCount[slot]);
							...
							@Pc(398) Pix32MapView image = child.invSlotSprite[slot];
				...
				if (child.fill) {
					Pix2DMapView.fillRect(childX, childY, child.colour, child.width, child.height);
				} else {
					Pix2DMapView.drawRect(childX, childY, child.colour, child.width, child.height);
				}
			} else if (child.type == 4) {
				PixFontMapView font = child.font;
				...
				if (child.buttonType == ComponentMapView.BUTTON_CONTINUE && this.pressedContinueOption) {
					text = "Please wait...";
					color = child.colour;
				}
				...
				int tmpX = Pix3DMapView.centerW3D;
				int tmpY = Pix3DMapView.centerH3D;

				Pix3DMapView.centerW3D = childX + child.width / 2;
				Pix3DMapView.centerH3D = childY + child.height / 2;

				int eyeY = Pix3DMapView.sinTable[child.xan] * child.zoom >> 16;
				int eyeZ = Pix3DMapView.cosTable[child.xan] * child.zoom >> 16;
				...
				Pix3DMapView.centerW3D = tmpX;
				Pix3DMapView.centerH3D = tmpY;
				...
				for (int row = 0; row < child.height; row++) {
					for (int col = 0; col < child.width; col++) {
						if (child.invSlotObjId[slot] > 0) {
							@Pc(915) ObjTypeMapView obj = ObjTypeMapView.get(child.invSlotObjId[slot] - 1);
		...
		Pix2DMapView.setClipping(bottom, right, top, left);
	}

	@OriginalMember(owner = "client", name = "a", descriptor = "(ZILclient!kb;)V")
	...
	private void updateVarp(@OriginalArg(0) int id) {
		...
		if (clientcode == 1) {
			if (value == 1) {
				Pix3DMapView.setBrightness(0.9D);
			} else if (value == 2) {
				Pix3DMapView.setBrightness(0.8D);
			} else if (value == 3) {
				Pix3DMapView.setBrightness(0.7D);
			} else if (value == 4) {
				Pix3DMapView.setBrightness(0.6D);
			}

			ObjTypeMapView.iconCache.clear();
			this.redrawBackground = true;
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Lclient!x;BI)V")
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Lclient!x;I)V")
	...
	@OriginalMember(owner = "client", name = "b", descriptor = "(Lclient!x;I)V")
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(ILclient!x;)V")
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Lclient!x;B)V")
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(ZLclient!x;)V")
	...
	private void useMenuOption(@OriginalArg(1) int optionId) {
		...
		if (action == 903 || action == 363) {
			...
			if (ComponentMapView.instances[c].layer == this.viewportInterfaceId) {
				this.selectedArea = 1;
			}

			if (ComponentMapView.instances[c].layer == this.chatInterfaceId) {
				this.selectedArea = 3;
			}
			...
			this.objInterface = a;
			this.objSelectedName = ObjTypeMapView.get(a).name;
			...
			ObjTypeMapView obj = ObjTypeMapView.get(a);
			String examine;
			...
			ComponentMapView com = ComponentMapView.instances[c];
			...
			if (tag != -1) {
				...
				for (@Pc(1957) int i = 0; i < ComponentMapView.instances.length; i++) {
					if (ComponentMapView.instances[i] != null && ComponentMapView.instances[i].clientCode == 600) {
						this.reportAbuseInterfaceID = this.viewportInterfaceId = ComponentMapView.instances[i].layer;
						break;
					}
	...
	private void drawMenu() {
		...
		Pix2DMapView.fillRect(x, y, background, w, h);
		Pix2DMapView.fillRect(x + 1, y + 1, 0, w - 2, 16);
		Pix2DMapView.drawRect(x + 1, y + 18, 0, w - 2, h - 19);
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(ILclient!hc;)V")
	private void updateInterfaceContent(@OriginalArg(1) ComponentMapView componentMapView) {
		@Pc(4) int clientCode = componentMapView.clientCode;

		if (clientCode >= 1 && clientCode <= 100) {
			clientCode--;
			if (clientCode >= this.friendCount) {
				componentMapView.text = "";
				componentMapView.buttonType = 0;
			} else {
				componentMapView.text = this.friendName[clientCode];
				componentMapView.buttonType = 1;
			}
			...
			if (clientCode >= this.friendCount) {
				...
				if (this.friendWorld[clientCode] == 0) {
					componentMapView.text = "@red@Offline";
				} else if (this.friendWorld[clientCode] == nodeId) {
					componentMapView.text = "@gre@World-" + (this.friendWorld[clientCode] - 9);
				} else {
					componentMapView.text = "@yel@World-" + (this.friendWorld[clientCode] - 9);
				}
				componentMapView.buttonType = 1;
			}
		} else if (clientCode == 203) {
			componentMapView.scroll = this.friendCount * 15 + 20;
			if (componentMapView.scroll <= componentMapView.height) {
				componentMapView.scroll = componentMapView.height + 1;
			}
			...
			if (clientCode >= this.ignoreCount) {
				...
				componentMapView.text = JString.formatName(JString.fromBase37(this.ignoreName37[clientCode]));
				componentMapView.buttonType = 1;
			}
		} else if (clientCode == 503) {
			componentMapView.scroll = this.ignoreCount * 15 + 20;
			if (componentMapView.scroll <= componentMapView.height) {
				componentMapView.scroll = componentMapView.height + 1;
			}
		} else if (clientCode == 327) {
			componentMapView.xan = 150;
			componentMapView.yan = (int) (Math.sin((double) loopCycle / 40.0D) * 256.0D) & 0x7FF;
			if (this.updateDesignModel) {
				...
				componentMapView.model = model;
			}
		} else if (clientCode == 324) {
			if (this.genderButtonImage0 == null) {
				this.genderButtonImage0 = componentMapView.graphic;
				this.genderButtonImage1 = componentMapView.activeGraphic;
			}
			if (this.designGenderMale) {
				componentMapView.graphic = this.genderButtonImage1;
			} else {
				componentMapView.graphic = this.genderButtonImage0;
			}
			...
			componentMapView.text = this.reportAbuseInput;
			if (loopCycle % 20 < 10) {
				componentMapView.text = componentMapView.text + "|";
			} else {
				componentMapView.text = componentMapView.text + " ";
			}
			...
			if (!this.rights) {
				...
				componentMapView.colour = 16711680;
				componentMapView.text = "Moderator option: Mute player for 48 hours: <ON>";
			} else {
				componentMapView.colour = 16777215;
				componentMapView.text = "Moderator option: Mute player for 48 hours: <OFF>";
			}
			...
			if (this.lastAddress == 0) {
				...
				componentMapView.text = "You last logged in " + text + " from: " + signlinkMapView.dns;
			}
		} else if (clientCode == 651) {
			if (this.unreadMessages == 0) {
				componentMapView.text = "0 unread messages";
				componentMapView.colour = 16776960;
			}
			if (this.unreadMessages == 1) {
				componentMapView.text = "1 unread message";
				componentMapView.colour = 65280;
			}
			if (this.unreadMessages > 1) {
				componentMapView.text = this.unreadMessages + " unread messages";
				componentMapView.colour = 65280;
			}
			...
			if (this.daysSinceRecoveriesChanged == 201) {
				...
				componentMapView.text = "You have not yet set any password recovery questions.";
			} else {
				String text;
				...
				componentMapView.text = text + " you changed your recovery questions";
			}
		} else if (clientCode == 653) {
			if (this.daysSinceRecoveriesChanged == 201) {
				componentMapView.text = "";
			} else if (this.daysSinceRecoveriesChanged == 200) {
				componentMapView.text = "We strongly recommend you do so now to secure your account.";
			} else {
				componentMapView.text = "If you do not remember making this change then cancel it immediately";
			}
		} else if (clientCode == 654) {
			if (this.daysSinceRecoveriesChanged == 201) {
				componentMapView.text = "";
			} else if (this.daysSinceRecoveriesChanged == 200) {
				componentMapView.text = "Do this from the 'account management' area on our front webpage";
			} else {
				componentMapView.text = "Do this from the 'account management' area on our front webpage";
			}
		}
	...
	private boolean saveWave(@OriginalArg(0) byte[] src, @OriginalArg(1) int length) {
		boolean success = src == null || signlinkMapView.wavesave(src, length);
	...
	private boolean replayWave() {
		boolean success = signlinkMapView.wavereplay();
	...
	private void setWaveVolume(@OriginalArg(0) int volume) {
		signlinkMapView.wavevol = volume;
	}

	@OriginalMember(owner = "client", name = "a", descriptor = "(ZLclient!kb;I)V")
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(ZLclient!hc;)Z")
	private boolean handleInterfaceAction(@OriginalArg(1) ComponentMapView com) {
	...
	protected void load() {
		...
		try {
			...
			this.fontPlain11 = new PixFontMapView(this.archiveTitle, "p11");
			this.fontPlain12 = new PixFontMapView(this.archiveTitle, "p12");
			this.fontBold12 = new PixFontMapView(this.archiveTitle, "b12");
			this.fontQuill8 = new PixFontMapView(this.archiveTitle, "q8");
			...
			this.imageMinimap = new Pix32MapView(512, 512);
			this.drawProgress("Unpacking media", 75);
			this.imageInvback = new Pix8MapView(media, "invback", 0);
			this.imageChatback = new Pix8MapView(media, "chatback", 0);
			this.imageMapback = new Pix8MapView(media, "mapback", 0);
			this.imageBackbase1 = new Pix8MapView(media, "backbase1", 0);
			this.imageBackbase2 = new Pix8MapView(media, "backbase2", 0);
			this.imageBackhmid1 = new Pix8MapView(media, "backhmid1", 0);
			for (@Pc(424) int i = 0; i < 13; i++) {
				this.imageSideicons[i] = new Pix8MapView(media, "sideicons", i);
			}
			this.imageCompass = new Pix32MapView(media, "compass", 0);
			...
			try {
				for (int i = 0; i < 50; i++) {
					...
					this.imageMapscene[i] = new Pix8MapView(media, "mapscene", i);
				}
			} catch (@Pc(468) Exception ex) {
			}
			try {
				for (int i = 0; i < 50; i++) {
					this.imageMapfunction[i] = new Pix32MapView(media, "mapfunction", i);
				}
			} catch (@Pc(488) Exception ex) {
			}
			try {
				for (int i = 0; i < 20; i++) {
					this.imageHitmarks[i] = new Pix32MapView(media, "hitmarks", i);
				}
			} catch (@Pc(508) Exception ex) {
			}
			try {
				for (int i = 0; i < 20; i++) {
					this.imageHeadicons[i] = new Pix32MapView(media, "headicons", i);
				}
			} catch (@Pc(528) Exception ex) {
			}
			this.imageMapflag = new Pix32MapView(media, "mapflag", 0);
			for (int i = 0; i < 8; i++) {
				this.imageCrosses[i] = new Pix32MapView(media, "cross", i);
			}
			this.imageMapdot0 = new Pix32MapView(media, "mapdots", 0);
			this.imageMapdot1 = new Pix32MapView(media, "mapdots", 1);
			this.imageMapdot2 = new Pix32MapView(media, "mapdots", 2);
			this.imageMapdot3 = new Pix32MapView(media, "mapdots", 3);
			this.imageScrollbar0 = new Pix8MapView(media, "scrollbar", 0);
			this.imageScrollbar1 = new Pix8MapView(media, "scrollbar", 1);
			this.imageRedstone1 = new Pix8MapView(media, "redstone1", 0);
			this.imageRedstone2 = new Pix8MapView(media, "redstone2", 0);
			this.imageRedstone3 = new Pix8MapView(media, "redstone3", 0);
			this.imageRedstone1h = new Pix8MapView(media, "redstone1", 0);
			this.imageRedstone1h.flipHorizontally();
			this.imageRedstone2h = new Pix8MapView(media, "redstone2", 0);
			this.imageRedstone2h.flipHorizontally();
			this.imageRedstone1v = new Pix8MapView(media, "redstone1", 0);
			this.imageRedstone1v.flipVertically();
			this.imageRedstone2v = new Pix8MapView(media, "redstone2", 0);
			this.imageRedstone2v.flipVertically();
			this.imageRedstone3v = new Pix8MapView(media, "redstone3", 0);
			this.imageRedstone3v.flipVertically();
			this.imageRedstone1hv = new Pix8MapView(media, "redstone1", 0);
			this.imageRedstone1hv.flipHorizontally();
			this.imageRedstone1hv.flipVertically();
			this.imageRedstone2hv = new Pix8MapView(media, "redstone2", 0);
			this.imageRedstone2hv.flipHorizontally();
			this.imageRedstone2hv.flipVertically();
			@Pc(725) Pix32MapView backleft1 = new Pix32MapView(media, "backleft1", 0);
			this.areaBackleft1 = new PixMapMapView(this.getBaseComponent(), backleft1.width, backleft1.height);
			backleft1.blitOpaque(0, 0);
			@Pc(750) Pix32MapView backleft2 = new Pix32MapView(media, "backleft2", 0);
			this.areaBackleft2 = new PixMapMapView(this.getBaseComponent(), backleft2.width, backleft2.height);
			backleft2.blitOpaque(0, 0);
			@Pc(775) Pix32MapView backright1 = new Pix32MapView(media, "backright1", 0);
			this.areaBackright1 = new PixMapMapView(this.getBaseComponent(), backright1.width, backright1.height);
			backright1.blitOpaque(0, 0);
			@Pc(800) Pix32MapView backright2 = new Pix32MapView(media, "backright2", 0);
			this.areaBackright2 = new PixMapMapView(this.getBaseComponent(), backright2.width, backright2.height);
			backright2.blitOpaque(0, 0);
			@Pc(825) Pix32MapView backtop1 = new Pix32MapView(media, "backtop1", 0);
			this.areaBacktop1 = new PixMapMapView(this.getBaseComponent(), backtop1.width, backtop1.height);
			backtop1.blitOpaque(0, 0);
			@Pc(850) Pix32MapView backtop2 = new Pix32MapView(media, "backtop2", 0);
			this.areaBacktop2 = new PixMapMapView(this.getBaseComponent(), backtop2.width, backtop2.height);
			backtop2.blitOpaque(0, 0);
			@Pc(875) Pix32MapView backvmid1 = new Pix32MapView(media, "backvmid1", 0);
			this.areaBackvmid1 = new PixMapMapView(this.getBaseComponent(), backvmid1.width, backvmid1.height);
			backvmid1.blitOpaque(0, 0);
			@Pc(900) Pix32MapView backvmid2 = new Pix32MapView(media, "backvmid2", 0);
			this.areaBackvmid2 = new PixMapMapView(this.getBaseComponent(), backvmid2.width, backvmid2.height);
			backvmid2.blitOpaque(0, 0);
			@Pc(925) Pix32MapView backvmid3 = new Pix32MapView(media, "backvmid3", 0);
			this.areaBackvmid3 = new PixMapMapView(this.getBaseComponent(), backvmid3.width, backvmid3.height);
			backvmid3.blitOpaque(0, 0);
			@Pc(950) Pix32MapView backhmid2 = new Pix32MapView(media, "backhmid2", 0);
			this.areaBackhmid2 = new PixMapMapView(this.getBaseComponent(), backhmid2.width, backhmid2.height);
			...
			ObjTypeMapView.membersWorld = members;
			if (!lowMemory) {
			...
			@Pc(1150) PixFontMapView[] fonts = new PixFontMapView[] { this.fontPlain11, this.fontPlain12, this.fontBold12, this.fontQuill8 };
			...
			Pix3DMapView.init3D(479, 96);
			this.areaChatbackOffsets = Pix3DMapView.lineOffset;
			Pix3DMapView.init3D(190, 261);
			this.areaSidebarOffsets = Pix3DMapView.lineOffset;
			Pix3DMapView.init3D(512, 334);
			this.areaViewportOffsets = Pix3DMapView.lineOffset;

			@Pc(1312) int[] distance = new int[9];
			for (int x = 0; x < 9; x++) {
				int angle = x * 32 + 128 + 15;
				@Pc(1330) int offset = angle * 3 + 600;
				@Pc(1334) int sin = Pix3DMapView.sinTable[angle];
	...
	private void handleInput() {
		...
		if (super.mouseX > 8 && super.mouseY > 11 && super.mouseX < 520 && super.mouseY < 345) {
			if (this.viewportInterfaceId == -1) {
				...
				this.handleInterfaceInput(ComponentMapView.instances[this.viewportInterfaceId], super.mouseX, super.mouseY, 8, 11, 0);
			}
		}
		...
		if (super.mouseX > 562 && super.mouseY > 231 && super.mouseX < 752 && super.mouseY < 492) {
			if (this.sidebarInterfaceId != -1) {
				this.handleInterfaceInput(ComponentMapView.instances[this.sidebarInterfaceId], super.mouseX, super.mouseY, 562, 231, 0);
			} else if (this.tabInterfaceId[this.selectedTab] != -1) {
				this.handleInterfaceInput(ComponentMapView.instances[this.tabInterfaceId[this.selectedTab]], super.mouseX, super.mouseY, 562, 231, 0);
			}
		}
		...
		if (super.mouseX > 22 && super.mouseY > 375 && super.mouseX < 431 && super.mouseY < 471) {
			if (this.chatInterfaceId == -1) {
				...
				this.handleInterfaceInput(ComponentMapView.instances[this.chatInterfaceId], super.mouseX, super.mouseY, 22, 375, 0);
			}
		}
	...
	private void clearCaches() {
		...
		ObjTypeMapView.modelCache.clear();
		ObjTypeMapView.iconCache.clear();
	...
	private void draw3DEntityElements() {
		...
		if (this.viewportInterfaceId != -1) {
			...
			this.drawInterface(ComponentMapView.instances[this.viewportInterfaceId], 0, 0, 0);
		}
	...
	private void drawTileOverlay(int x, int z, int level, int size, int color, boolean crossed) {
		...
		if (crossed) {
			Pix2DMapView.line(x0, y0, x3, y3, (color & 0xFEFEFE) >> 1);
			Pix2DMapView.line(x1, y1, x2, y2, (color & 0xFEFEFE) >> 1);
		}

		Pix2DMapView.line(x0, y0, x1, y1, color);
		Pix2DMapView.line(x0, y0, x2, y2, color);
		Pix2DMapView.line(x1, y1, x3, y3, color);
		Pix2DMapView.line(x2, y2, x3, y3, color);
	}
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(IILclient!hb;I)V")
	private void drawOnMinimap(@OriginalArg(0) int dy, @OriginalArg(2) Pix32MapView image, @OriginalArg(3) int dx) {
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(IZLclient!x;)V")
	...
	private void project(int x, int y, int z) {
		...
		if (dz >= 50) {
			this.projectX = Pix3DMapView.centerW3D + (dx << 9) / dz;
			this.projectY = Pix3DMapView.centerH3D + (dy << 9) / dz;
		} else {
			this.projectX = -1;
			this.projectY = -1;
		}
	...
	private void loadTitle() {
		...
		this.imageTitle0 = new PixMapMapView(this.getBaseComponent(), 128, 265);
		Pix2DMapView.clear();

		this.imageTitle1 = new PixMapMapView(this.getBaseComponent(), 128, 265);
		Pix2DMapView.clear();

		this.imageTitle2 = new PixMapMapView(this.getBaseComponent(), 533, 186);
		Pix2DMapView.clear();

		this.imageTitle3 = new PixMapMapView(this.getBaseComponent(), 360, 146);
		Pix2DMapView.clear();

		this.imageTitle4 = new PixMapMapView(this.getBaseComponent(), 360, 200);
		Pix2DMapView.clear();

		this.imageTitle5 = new PixMapMapView(this.getBaseComponent(), 214, 267);
		Pix2DMapView.clear();

		this.imageTitle6 = new PixMapMapView(this.getBaseComponent(), 215, 267);
		Pix2DMapView.clear();

		this.imageTitle7 = new PixMapMapView(this.getBaseComponent(), 86, 79);
		Pix2DMapView.clear();

		this.imageTitle8 = new PixMapMapView(this.getBaseComponent(), 87, 79);
		Pix2DMapView.clear();
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(IIIIIZIILclient!hc;)V")
	private void handleScrollInput(@OriginalArg(0) int mouseX, @OriginalArg(2) int mouseY, @OriginalArg(3) int scrollableHeight, @OriginalArg(4) int height, @OriginalArg(5) boolean redraw, @OriginalArg(6) int left, @OriginalArg(7) int top, @OriginalArg(8) ComponentMapView componentMapView) {
		...
		if (mouseX >= left && mouseX < left + 16 && mouseY >= top && mouseY < top + 16) {
			componentMapView.scrollPosition -= this.dragCycles * 4;
			if (redraw) {
				this.redrawSidebar = true;
			}
			...
			componentMapView.scrollPosition = (scrollableHeight - height) * gripY / maxY;
			if (redraw) {
				this.redrawSidebar = true;
			}
	...
	private void login(@OriginalArg(0) String username, @OriginalArg(1) String password, @OriginalArg(2) boolean reconnect) {
		signlinkMapView.errorname = username;
		try {
			if (!reconnect) {
				this.loginMessage0 = "";
			...
			this.stream = new ClientStreamMapView(this, this.openSocket(Configuration.PORT_OFFSET + 43594));
			...
			this.out.p4(seed[2]);
			this.out.p4(seed[3]);
			this.out.p4(signlinkMapView.uid);
			...
			this.login.p1(signlinkMapView.clientversion);
	...
	protected void unload() {
		signlinkMapView.reporterror = false;
		...
		LocType.unload();
		NpcType.unload();
		ObjTypeMapView.unload();
		FloType.instances = null;
		IdkType.instances = null;
		ComponentMapView.instances = null;
				...
				if (super.mouseButton == 0) {
					...
					if (this.objGrabThreshold && this.objDragCycles >= 5) {
						...
						if (this.hoveredSlotParentId == this.objDragInterfaceId && this.hoveredSlot != this.objDragSlot) {
							@Pc(502) ComponentMapView com = ComponentMapView.instances[this.objDragInterfaceId];
	...
	@OriginalMember(owner = "client", name = "b", descriptor = "(Lclient!kb;II)V")
	private void getPlayer(@OriginalArg(0) Packet buf, @OriginalArg(1) int size) {
		...
		if (buf.pos != size) {
			signlinkMapView.reporterror("Error packet size mismatch in getplayer pos:" + buf.pos + " psize:" + size);
			throw new RuntimeException("eek");
		}

		for (int index = 0; index < this.playerCount; index++) {
			if (this.players[this.playerIds[index]] == null) {
				signlinkMapView.reporterror(this.username + " null entry in pl list - pos:" + index + " size:" + this.playerCount);
				throw new RuntimeException("eek");
			}
		}
	}
	...
	private boolean updateInterfaceAnimation(@OriginalArg(0) int id, @OriginalArg(1) int delta) {
		...
		@Pc(7) ComponentMapView parent = ComponentMapView.instances[id];
		for (@Pc(9) int i = 0; i < parent.childId.length && parent.childId[i] != -1; i++) {
			@Pc(24) ComponentMapView child = ComponentMapView.instances[parent.childId[i]];
			if (child.type == 1) {
	...
	private void resetInterfaceAnimation(@OriginalArg(1) int id) {
		@Pc(3) ComponentMapView parent = ComponentMapView.instances[id];
		for (@Pc(5) int i = 0; i < parent.childId.length && parent.childId[i] != -1; i++) {
			@Pc(20) ComponentMapView child = ComponentMapView.instances[parent.childId[i]];
			if (child.type == 1) {
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Lclient!hc;I)Z")
	private boolean executeInterfaceScript(@OriginalArg(0) ComponentMapView com) {
	...
	private void handleMinimapInput() {
		if (super.mouseClickButton == 1) {
			...
			if (x >= 0 && y >= 0 && x < 146 && y < 151) {
				...
				@Pc(48) int sinYaw = Pix3DMapView.sinTable[yaw];
				@Pc(52) int cosYaw = Pix3DMapView.cosTable[yaw];
		...
		if (this.menuVisible) {
			...
			if (button == 1 && this.menuSize > 0) {
				...
				if (action == 602 || action == 596 || action == 22 || action == 892 || action == 415 || action == 405 || action == 38 || action == 422 || action == 478 || action == 347 || action == 188) {
					...
					@Pc(283) ComponentMapView com = ComponentMapView.instances[comId];
					...
					if (com.draggable) {
						...
						if (ComponentMapView.instances[comId].layer == this.viewportInterfaceId) {
							this.objDragArea = 1;
						}

						if (ComponentMapView.instances[comId].layer == this.chatInterfaceId) {
							this.objDragArea = 3;
						}
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Lclient!hc;B)Z")
	private boolean handleSocialMenuOption(@OriginalArg(0) ComponentMapView componentMapView) {
		@Pc(2) int type = componentMapView.clientCode;
		if (type >= 1 && type <= 200) {
			if (type >= 101) {
				type -= 101;
			} else {
			...
			this.menuOption[this.menuSize] = "Remove @whi@" + componentMapView.text;
	...
	@OriginalMember(owner = "client", name = "b", descriptor = "(ILclient!kb;I)V")
	private void getNpcPosOldVis(@OriginalArg(1) Packet buf, @OriginalArg(2) int size) {
		...
		if (count > this.npcCount) {
			signlinkMapView.reporterror(this.username + " Too many npcs");
			throw new RuntimeException("eek");
		}
...
/*		if (signlink.mainapp != null) {
	...
	private void tryReconnect() {
		if (this.idleTimeout > 0) {
			...
			this.areaViewport.draw(super.graphics, 8, 11);
			this.flagSceneTileX = 0;
			@Pc(60) ClientStreamMapView stream = this.stream;
			this.ingame = false;
			post(new InGameChanged(this.ingame));
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(ILclient!ib;)V")
	private void updateFlameBuffer(@OriginalArg(1) Pix8MapView image) {
	...
	private void sortObjStacks(@OriginalArg(0) int x, @OriginalArg(1) int z) {
		...
		for (ObjStackEntity obj = (ObjStackEntity) objStacks.head(); obj != null; obj = (ObjStackEntity) objStacks.next()) {
			@Pc(32) ObjTypeMapView type = ObjTypeMapView.get(obj.index);
			int cost = type.cost;
		...
		if (bottomObjId != -1) {
			bottomObj = ObjTypeMapView.get(bottomObjId).getInterfaceModel(bottomObjCount);
		}

		@Pc(128) Model middleObj = null;
		if (middleObjId != -1) {
			middleObj = ObjTypeMapView.get(middleObjId).getInterfaceModel(middleObjCount);
		}

		@Pc(144) int bitset = x + (z << 7) + 1610612736;
		@Pc(148) ObjTypeMapView type = ObjTypeMapView.get(topObj.index);
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(Lclient!hc;ZI)I")
	private int executeClientscript1(@OriginalArg(0) ComponentMapView componentMapView, @OriginalArg(2) int scriptId) {
		if (componentMapView.scripts == null || scriptId >= componentMapView.scripts.length) {
			return -2;
		}

		try {
			@Pc(26) int[] script = componentMapView.scripts[scriptId];
			...
			while (true) {
				...
				if (opcode == 1) { // load_skill_level {skill}
					...
					ComponentMapView com = ComponentMapView.instances[script[pc++]];
					int obj = script[pc++] + 1;
	...
	private void loadTitleBackground() {
		...
		@Pc(14) Pix32MapView title = new Pix32MapView(data);
		...
		title = new Pix32MapView(this.archiveTitle, "logo", 0);
		this.imageTitle2.bind();
		...
		for (@Pc(52) int picked = 0; picked < Model.pickedCount; picked++) {
			...
			if (entityType == 3) {
				...
				for (@Pc(572) ObjStackEntity obj = (ObjStackEntity) objs.tail(); obj != null; obj = (ObjStackEntity) objs.prev()) {
					@Pc(578) ObjTypeMapView type = ObjTypeMapView.get(obj.index);
					if (this.objSelected == 1) {
	...
	@OriginalMember(owner = "client", name = "b", descriptor = "(IILclient!kb;)V")
	...
	private void drawChatback() {
		...
		Pix3DMapView.lineOffset = this.areaChatbackOffsets;
		...
		if (this.showSocialInput) {
			...
			this.drawInterface(ComponentMapView.instances[this.chatInterfaceId], 0, 0, 0);
		} else if (this.stickyChatInterfaceId == -1) {
			@Pc(135) PixFontMapView font = this.fontPlain12;
			@Pc(137) int line = 0;
			Pix2DMapView.setClipping(77, 463, 0, 0);
			...
			Pix2DMapView.hline(0, 77, 0, 479);
		} else {
			this.drawInterface(ComponentMapView.instances[this.stickyChatInterfaceId], 0, 0, 0);
		}
		if (this.menuVisible && this.menuArea == 2) {
			this.drawMenu();
		}
		...
		this.areaViewport.bind();
		Pix3DMapView.lineOffset = this.areaViewportOffsets;
	}
	...
	private boolean read() {
		...
		try {
			...
			if (this.packetType == 80) {
				...
				if (index != -1) {
					signlinkMapView.cachesave("m" + x + "_" + z, this.sceneMapLandData[index]);
					this.sceneState = 1;
				}
				this.packetType = -1;
				return true;
			...
			if (this.packetType == 237) {
				...
				for (int i = 0; i < regions; i++) {
					...
					@Pc(686) byte[] data;
					if (landCrc != 0) {
						data = signlinkMapView.cacheload("m" + mapsquareX + "_" + mapsquareZ);
						if (data != null) {
							this.crc32.reset();
							this.crc32.update(data);
					...
					if (locCrc != 0) {
						data = signlinkMapView.cacheload("l" + mapsquareX + "_" + mapsquareZ);
						if (data != null) {
							this.crc32.reset();
							this.crc32.update(data);
			...
			if (this.packetType == 197) {
				// IF_SETPLAYERHEAD
				int com = this.in.g2();
				ComponentMapView.instances[com].model = this.localPlayer.getHeadModel();
				this.packetType = -1;
				return true;
			}
			...
			if (this.packetType == 20) {
				...
				if (index != -1) {
					signlinkMapView.cachesave("l" + x + "_" + z, this.sceneMapLocData[index]);
					this.sceneState = 1;
				}
				this.packetType = -1;
				return true;
			...
			if (this.packetType == 146) {
				...
				ComponentMapView.instances[com].anim = seqId;
				this.packetType = -1;
				return true;
			}
			...
			if (this.packetType == 98) {
				...
				this.redrawSidebar = true;
				int com = this.in.g2();
				ComponentMapView inv = ComponentMapView.instances[com];
				int size = this.in.g1();
			...
			if (this.packetType == 140) {
				...
				if (this.lastAddress != 0 && this.viewportInterfaceId == -1) {
					signlinkMapView.dnslookup(JString.formatIPv4(this.lastAddress));
					this.closeInterfaces();
					...
					this.reportAbuseInput = "";
					this.reportAbuseMuteOption = false;
					for (int i = 0; i < ComponentMapView.instances.length; i++) {
						if (ComponentMapView.instances[i] != null && ComponentMapView.instances[i].clientCode == clientCode) {
							this.viewportInterfaceId = ComponentMapView.instances[i].layer;
							break;
						}
					}
				}
			...
			if (this.packetType == 204) {
				...
				ComponentMapView.instances[com].model = npc.getHeadModel();
				this.packetType = -1;
				return true;
			}
			...
			if (this.packetType == 103) {
				...
				int src = this.in.g2();
				int dst = this.in.g2();
				ComponentMapView inter = ComponentMapView.instances[com];
			...
			if (this.packetType == 41) {
				...
				if (!ignored && this.overrideChat == 0) {
					try {
						...
						signlinkMapView.reporterror("cde1");
					}
				}
				this.packetType = -1;
				return true;
			...
			if (this.packetType == 87) {
				...
				ComponentMapView.instances[com].model = new Model(model);
				this.packetType = -1;
				return true;
			}
			...
			if (this.packetType == 46) {
				...
				int zoom = this.in.g2();
				@Pc(3157) ObjTypeMapView obj = ObjTypeMapView.get(objId);
				ComponentMapView.instances[com].model = obj.getInterfaceModel(50);
				ComponentMapView.instances[com].xan = obj.xan2d;
				ComponentMapView.instances[com].yan = obj.yan2d;
				ComponentMapView.instances[com].zoom = obj.zoom2d * 100 / zoom;
				this.packetType = -1;
				return true;
			}
			...
			if (this.packetType == 2) {
				...
				int g = color >> 5 & 0x1F;
				int b = color & 0x1F;
				ComponentMapView.instances[com].colour = (r << 19) + (g << 11) + (b << 3);
				this.packetType = -1;
				return true;
			}
			...
			if (this.packetType == 26) {
				...
				ComponentMapView.instances[com].hide = hide;
				this.packetType = -1;
				return true;
			}
			...
			if (this.packetType == 201) {
				...
				ComponentMapView.instances[com].text = text;
				if (ComponentMapView.instances[com].layer == this.tabInterfaceId[this.selectedTab]) {
					this.redrawSidebar = true;
				}
				this.packetType = -1;
				return true;
			...
			signlinkMapView.reporterror("T1 - " + this.packetType + "," + this.packetSize + " - " + this.lastPacketType1 + "," + this.lastPacketType2);
			this.logout();
			...
			signlinkMapView.reporterror(error);
			this.logout();
		}
		return true;
	}
	...
	private void drawSidebar() {
		...
		Pix3DMapView.lineOffset = this.areaSidebarOffsets;
		this.imageInvback.draw(0, 0);
		if (this.sidebarInterfaceId != -1) {
			this.drawInterface(ComponentMapView.instances[this.sidebarInterfaceId], 0, 0, 0);
		} else if (this.tabInterfaceId[this.selectedTab] != -1) {
			this.drawInterface(ComponentMapView.instances[this.tabInterfaceId[this.selectedTab]], 0, 0, 0);
		}
		if (this.menuVisible && this.menuArea == 1) {
			this.drawMenu();
		}
	...
	@OriginalMember(owner = "client", name = "a", descriptor = "(ZIILclient!kb;Lclient!z;)V")
			...
			if (player.name != null) {
				...
				if (!ignored && this.overrideChat == 0) {
					try {
						...
						signlinkMapView.reporterror("cde2");
					}
				}
			}
	...
	protected void drawProgress(@OriginalArg(1) String message, @OriginalArg(2) int progress) {
		...
		if (this.archiveTitle == null) {
			...
			Pix2DMapView.drawRect(x / 2 - 152, midY, 9179409, 304, 34);
			Pix2DMapView.drawRect(x / 2 - 151, midY + 1, 0, 302, 32);
			Pix2DMapView.fillRect(x / 2 - 150, midY + 2, 9179409, progress * 3, 30);
			Pix2DMapView.fillRect(x / 2 - 150 + progress * 3, midY + 2, 0, 300 - progress * 3, 30);
