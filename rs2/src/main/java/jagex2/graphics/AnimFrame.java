...
@OriginalClass("client.client!g")
public class AnimFrame {

	@OriginalMember(owner = "client.client!g", name = "a", descriptor = "[Lclient!g;")
	public static AnimFrame[] instances;

	@OriginalMember(owner = "client.client!g", name = "b", descriptor = "I")
	public int delay;

	@OriginalMember(owner = "client.client!g", name = "c", descriptor = "Lclient!f;")
	public AnimBase base;

	@OriginalMember(owner = "client.client!g", name = "d", descriptor = "I")
	public int length;

	// groups to use from base
	@OriginalMember(owner = "client.client!g", name = "e", descriptor = "[I")
	public int[] groups;

	// x adjustment for group
	@OriginalMember(owner = "client.client!g", name = "f", descriptor = "[I")
	public int[] x;

	// y adjustment for group
	@OriginalMember(owner = "client.client!g", name = "g", descriptor = "[I")
	public int[] y;

	// z adjustment for group
	@OriginalMember(owner = "client.client!g", name = "h", descriptor = "[I")
	public int[] z;

	@OriginalMember(owner = "client.client!g", name = "a", descriptor = "(ZLclient!ub;)V")
