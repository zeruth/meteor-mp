...
@OriginalClass("client.client!hb")
public class Pix32MapView extends Pix2DMapView {

	@OriginalMember(owner = "client.client!hb", name = "A", descriptor = "[I")
	public int[] pixels;

	@OriginalMember(owner = "client.client!hb", name = "B", descriptor = "I")
	public int width;

	@OriginalMember(owner = "client.client!hb", name = "C", descriptor = "I")
	public int height;

	@OriginalMember(owner = "client.client!hb", name = "D", descriptor = "I")
	private int cropX;

	@OriginalMember(owner = "client.client!hb", name = "E", descriptor = "I")
	private int cropY;

	@OriginalMember(owner = "client.client!hb", name = "F", descriptor = "I")
	public int cropW;

	@OriginalMember(owner = "client.client!hb", name = "G", descriptor = "I")
	public int cropH;

	@OriginalMember(owner = "client.client!hb", name = "<init>", descriptor = "(II)V")
	public Pix32MapView(@OriginalArg(0) int width, @OriginalArg(1) int height) {
	...
	@OriginalMember(owner = "client.client!hb", name = "<init>", descriptor = "([BLjava/awt/Component;)V")
	public Pix32MapView(@OriginalArg(0) byte[] src) {
		if (isAndroid) {
			try {
			...
			try {
				...
				@Pc(22) MediaTracker tracker = new MediaTracker(new JPanel());
	...
	@OriginalMember(owner = "client.client!hb", name = "<init>", descriptor = "(Lclient!ub;Ljava/lang/String;I)V")
	public Pix32MapView(@OriginalArg(0) Jagfile jag, @OriginalArg(1) String name, @OriginalArg(2) int index) {
	...
	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(B)V")
	public void bind() {
		Pix2DMapView.bind(this.width, this.height, this.pixels);
	}

	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(IIIZ)V")
	...
	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(III)V")
	public void blitOpaque(@OriginalArg(1) int x, @OriginalArg(2) int y) {
		x += this.cropX;
		y += this.cropY;

		@Pc(15) int dstOff = x + y * Pix2DMapView.width2d;
		@Pc(17) int srcOff = 0;
		@Pc(20) int h = this.height;
		@Pc(23) int w = this.width;
		@Pc(27) int dstStep = Pix2DMapView.width2d - w;
		@Pc(29) int srcStep = 0;

		if (y < Pix2DMapView.boundTop) {
			int cutoff = Pix2DMapView.boundTop - y;
			h -= cutoff;
			y = Pix2DMapView.boundTop;
			srcOff += cutoff * w;
			dstOff += cutoff * Pix2DMapView.width2d;
		}

		if (y + h > Pix2DMapView.boundBottom) {
			h -= y + h - Pix2DMapView.boundBottom;
		}

		if (x < Pix2DMapView.boundLeft) {
			int cutoff = Pix2DMapView.boundLeft - x;
			w -= cutoff;
			x = Pix2DMapView.boundLeft;
			srcOff += cutoff;
			dstOff += cutoff;
			srcStep += cutoff;
			dstStep += cutoff;
		...
		if (x + w > Pix2DMapView.boundRight) {
			int cutoff = x + w - Pix2DMapView.boundRight;
			w -= cutoff;
			srcStep += cutoff;
			dstStep += cutoff;
		}
		...
		if (w > 0 && h > 0) {
			this.copyPixels(w, h, this.pixels, srcOff, srcStep, Pix2DMapView.data, dstOff, dstStep);
		}
	}

	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(I[IIIIIII[I)V")
	...
	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(IIZ)V")
	public void draw(@OriginalArg(1) int x, @OriginalArg(0) int y) {
		x += this.cropX;
		y += this.cropY;

		@Pc(20) int dstOff = x + y * Pix2DMapView.width2d;
		@Pc(22) int srcOff = 0;
		@Pc(25) int h = this.height;
		@Pc(28) int w = this.width;
		@Pc(32) int dstStep = Pix2DMapView.width2d - w;
		@Pc(34) int srcStep = 0;
		...
		if (w > 0 && h > 0) {
			this.copyPixels(Pix2DMapView.data, this.pixels, srcOff, dstOff, w, h, dstStep, srcStep);
		}
	}

	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "([I[IIIIIIII)V")
	...
	@OriginalMember(owner = "client.client!hb", name = "d", descriptor = "(IIIII)V")
	public void crop(@OriginalArg(4) int x, @OriginalArg(1) int y, @OriginalArg(2) int w, @OriginalArg(0) int h) {
		try {
			...
			@Pc(137) int dstStep = x + y * Pix2DMapView.width2d;
			@Pc(141) int dstOff = Pix2DMapView.width2d - w;

			if (y < Pix2DMapView.boundTop) {
				int cutoff = Pix2DMapView.boundTop - y;
				h -= cutoff;
				y = 0;
				dstStep += cutoff * Pix2DMapView.width2d;
			...
			this.scale(w, h, this.pixels, offW, offH, Pix2DMapView.data, dstOff, dstStep, currentW, scaleCropWidth, scaleCropHeight);
		} catch (@Pc(243) Exception ignored) {
			System.out.println("error in sprite clipping routine");
		}
	}

	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(II[IIIII[IIIIII)V")
	...
	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(IIIB)V")
	public void drawAlpha(@OriginalArg(0) int alpha, @OriginalArg(1) int x, @OriginalArg(2) int y) {
		x += this.cropX;
		y += this.cropY;

		@Pc(4) int dstStep = x + y * Pix2DMapView.width2d;
		@Pc(27) int srcStep = 0;
		@Pc(30) int h = this.height;
		@Pc(33) int w = this.width;
		@Pc(37) int dstOff = Pix2DMapView.width2d - w;
		@Pc(39) int srcOff = 0;
		...
		if (w > 0 && h > 0) {
			this.copyPixelsAlpha(w, h, this.pixels, srcStep, srcOff, Pix2DMapView.data, dstStep, dstOff, alpha);
		}
	}

	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(II[III[IIBIII)V")
	...
	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(II[IIIIIIIZ[I)V")
	public void drawRotatedMasked(@OriginalArg(7) int x, @OriginalArg(8) int y, @OriginalArg(1) int w, @OriginalArg(3) int h, @OriginalArg(2) int[] lineStart, @OriginalArg(10) int[] lineWidth, @OriginalArg(6) int anchorX, @OriginalArg(4) int anchorY, @OriginalArg(0) int theta, @OriginalArg(5) int zoom) {
		try {
			...
			@Pc(81) int leftOff = x + y * Pix2DMapView.width2d;
			...
			for (@Pc(83) int i = 0; i < h; i++) {
				...
				for (@Pc(110) int j = -lineWidth[i]; j < 0; j++) {
					Pix2DMapView.data[dstX++] = this.pixels[(srcX >> 16) + (srcY >> 16) * this.width];
					srcX += cosZoom;
					srcY -= sinZoom;
				}
				...
				leftX += sinZoom;
				leftY += cosZoom;
				leftOff += Pix2DMapView.width2d;
			}
		} catch (@Pc(158) Exception ignored) {
		}
	}

	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(Lclient!ib;IIB)V")
	public void drawMasked(@OriginalArg(2) int x, @OriginalArg(1) int y, @OriginalArg(0) Pix8MapView mask) {
		x += this.cropX;
		y += this.cropY;

		@Pc(15) int dstStep = x + y * Pix2DMapView.width2d;
		@Pc(17) int srcStep = 0;
		@Pc(24) int h = this.height;
		@Pc(27) int w = this.width;
		@Pc(31) int dstOff = Pix2DMapView.width2d - w;
		@Pc(33) int srcOff = 0;
		...
		if (w > 0 && h > 0) {
			this.copyPixelsMasked(w, h, this.pixels, srcOff, srcStep, Pix2DMapView.data, dstStep, dstOff, mask.pixels);
		}
	}

	@OriginalMember(owner = "client.client!hb", name = "a", descriptor = "(IIIIII[I[II[BI)V")
