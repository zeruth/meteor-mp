...
@OriginalClass("client.client!pb")
public class DoublyLinkList {

	@OriginalMember(owner = "client.client!pb", name = "d", descriptor = "Lclient!db;")
	private final DoublyLinkable head = new DoublyLinkable();

	@OriginalMember(owner = "client.client!pb", name = "<init>", descriptor = "(I)V")
	public DoublyLinkList() {
		this.head.next2 = this.head;
		this.head.prev2 = this.head;
	}

	@OriginalMember(owner = "client.client!pb", name = "a", descriptor = "(Lclient!db;)V")
	...
	@OriginalMember(owner = "client.client!pb", name = "a", descriptor = "()Lclient!db;")
