...
@OriginalClass("client.client!ab")
public class ProjectileEntity extends Entity {

	@OriginalMember(owner = "client.client!ab", name = "g", descriptor = "Lclient!kc;")
	private final SpotAnimType spotanim;

	@OriginalMember(owner = "client.client!ab", name = "h", descriptor = "I")
	public final int level;

	@OriginalMember(owner = "client.client!ab", name = "i", descriptor = "I")
	private final int srcX;

	@OriginalMember(owner = "client.client!ab", name = "j", descriptor = "I")
	private final int srcZ;

	@OriginalMember(owner = "client.client!ab", name = "k", descriptor = "I")
	private final int srcY;

	@OriginalMember(owner = "client.client!ab", name = "l", descriptor = "I")
	public final int offsetY;

	@OriginalMember(owner = "client.client!ab", name = "m", descriptor = "I")
	public final int startCycle;

	@OriginalMember(owner = "client.client!ab", name = "n", descriptor = "I")
	public final int lastCycle;

	@OriginalMember(owner = "client.client!ab", name = "o", descriptor = "I")
	private final int peakPitch;

	@OriginalMember(owner = "client.client!ab", name = "p", descriptor = "I")
	private final int arc;

	@OriginalMember(owner = "client.client!ab", name = "q", descriptor = "I")
	public final int target;

	@OriginalMember(owner = "client.client!ab", name = "r", descriptor = "Z")
	private boolean mobile = false;

	@OriginalMember(owner = "client.client!ab", name = "s", descriptor = "D")
	public double x;

	@OriginalMember(owner = "client.client!ab", name = "t", descriptor = "D")
	public double z;

	@OriginalMember(owner = "client.client!ab", name = "u", descriptor = "D")
	public double y;

	@OriginalMember(owner = "client.client!ab", name = "v", descriptor = "D")
	private double velocityX;

	@OriginalMember(owner = "client.client!ab", name = "w", descriptor = "D")
	private double velocityZ;

	@OriginalMember(owner = "client.client!ab", name = "x", descriptor = "D")
	private double velocity;

	@OriginalMember(owner = "client.client!ab", name = "y", descriptor = "D")
	private double velocityY;

	@OriginalMember(owner = "client.client!ab", name = "z", descriptor = "D")
	private double accelerationY;

	@OriginalMember(owner = "client.client!ab", name = "A", descriptor = "I")
	public int yaw;

	@OriginalMember(owner = "client.client!ab", name = "B", descriptor = "I")
	private int pitch;

	@OriginalMember(owner = "client.client!ab", name = "C", descriptor = "I")
	private int seqFrame;

	@OriginalMember(owner = "client.client!ab", name = "D", descriptor = "I")
	private int seqCycle;

	@OriginalMember(owner = "client.client!ab", name = "<init>", descriptor = "(IIIIIIIIIIII)V")
	...
	@OriginalMember(owner = "client.client!ab", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "client.client!ab", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "client.client!ab", name = "a", descriptor = "(Z)Lclient!eb;")
	@Override
