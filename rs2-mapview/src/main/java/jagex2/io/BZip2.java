...
@OriginalClass("client.client!rb")
public class BZip2 {

	@OriginalMember(owner = "client.client!rb", name = "a", descriptor = "Lclient!sb;")
	private static final BZip2State state = new BZip2State();

	@OriginalMember(owner = "client.client!rb", name = "a", descriptor = "([BI[BII)I")
	...
	@OriginalMember(owner = "client.client!rb", name = "a", descriptor = "(Lclient!sb;)V")
	...
	// BZ2_decompress
	@OriginalMember(owner = "client.client!rb", name = "b", descriptor = "(Lclient!sb;)V")
	...
	// macro: GET_UCHAR
	@OriginalMember(owner = "client.client!rb", name = "c", descriptor = "(Lclient!sb;)B")
	private static byte getUnsignedChar(@OriginalArg(0) BZip2State s) {
		return (byte) getBits(8, s);
	}

	// macro: GET_BIT
	@OriginalMember(owner = "client.client!rb", name = "d", descriptor = "(Lclient!sb;)B")
	private static byte getBit(@OriginalArg(0) BZip2State s) {
		return (byte) getBits(1, s);
	}

	// macro: GET_BITS
	@OriginalMember(owner = "client.client!rb", name = "a", descriptor = "(ILclient!sb;)I")
	...
	// makeMaps_d
	@OriginalMember(owner = "client.client!rb", name = "e", descriptor = "(Lclient!sb;)V")
	...
	@OriginalMember(owner = "client.client!rb", name = "a", descriptor = "([I[I[I[BIII)V")
	...
	@OriginalClass("client.client!sb")
	public static final class BZip2State {

		@OriginalMember(owner = "client.client!sb", name = "a", descriptor = "I")
		public static final int MTFA_SIZE = 4096;

		@OriginalMember(owner = "client.client!sb", name = "b", descriptor = "I")
		public static final int MTFL_SIZE = 16;

		@OriginalMember(owner = "client.client!sb", name = "c", descriptor = "I")
		public static final int BZ_MAX_ALPHA_SIZE = 258;

		@OriginalMember(owner = "client.client!sb", name = "d", descriptor = "I")
		public static final int BZ_MAX_CODE_LEN = 23;

		@OriginalMember(owner = "client.client!sb", name = "e", descriptor = "I")
		private static final int anInt732 = 1; // TODO

		@OriginalMember(owner = "client.client!sb", name = "f", descriptor = "I")
		private static final int BZ_N_GROUPS = 6;

		@OriginalMember(owner = "client.client!sb", name = "g", descriptor = "I")
		private static final int BZ_G_SIZE = 50;

		@OriginalMember(owner = "client.client!sb", name = "h", descriptor = "I")
		private static final int anInt735 = 4; // TODO

		@OriginalMember(owner = "client.client!sb", name = "i", descriptor = "I")
		...
		@OriginalMember(owner = "client.client!sb", name = "j", descriptor = "[B")
		public byte[] stream;

		@OriginalMember(owner = "client.client!sb", name = "k", descriptor = "I")
		public int next_in;

		@OriginalMember(owner = "client.client!sb", name = "l", descriptor = "I")
		public int avail_in;

		@OriginalMember(owner = "client.client!sb", name = "m", descriptor = "I")
		public int total_in_lo32;

		@OriginalMember(owner = "client.client!sb", name = "n", descriptor = "I")
		public int total_in_hi32;

		@OriginalMember(owner = "client.client!sb", name = "o", descriptor = "[B")
		public byte[] decompressed;

		@OriginalMember(owner = "client.client!sb", name = "p", descriptor = "I")
		public int next_out;

		@OriginalMember(owner = "client.client!sb", name = "q", descriptor = "I")
		public int avail_out;

		@OriginalMember(owner = "client.client!sb", name = "r", descriptor = "I")
		public int total_out_lo32;

		@OriginalMember(owner = "client.client!sb", name = "s", descriptor = "I")
		public int total_out_hi32;

		@OriginalMember(owner = "client.client!sb", name = "t", descriptor = "B")
		public byte state_out_ch;

		@OriginalMember(owner = "client.client!sb", name = "u", descriptor = "I")
		public int state_out_len;

		@OriginalMember(owner = "client.client!sb", name = "v", descriptor = "Z")
		public boolean blockRandomized;

		@OriginalMember(owner = "client.client!sb", name = "w", descriptor = "I")
		public int bsBuff;

		@OriginalMember(owner = "client.client!sb", name = "x", descriptor = "I")
		public int bsLive;

		@OriginalMember(owner = "client.client!sb", name = "y", descriptor = "I")
		public int blockSize100k;

		@OriginalMember(owner = "client.client!sb", name = "z", descriptor = "I")
		...
		@OriginalMember(owner = "client.client!sb", name = "J", descriptor = "[Z")
		public final boolean[] inUse = new boolean[256];

		@OriginalMember(owner = "client.client!sb", name = "K", descriptor = "[Z")
		public final boolean[] inUse16 = new boolean[16];

		@OriginalMember(owner = "client.client!sb", name = "L", descriptor = "[B")
		public final byte[] seqToUnseq = new byte[256];

		@OriginalMember(owner = "client.client!sb", name = "M", descriptor = "[B")
		...
		@OriginalMember(owner = "client.client!sb", name = "P", descriptor = "[B")
		public final byte[] selectorMtf = new byte[BZ_MAX_SELECTORS];

		@OriginalMember(owner = "client.client!sb", name = "Q", descriptor = "[[B")
		...
		@OriginalMember(owner = "client.client!sb", name = "T", descriptor = "[[I")
		public final int[][] perm = new int[BZ_N_GROUPS][BZ_MAX_ALPHA_SIZE];

		@OriginalMember(owner = "client.client!sb", name = "U", descriptor = "[I")
		public final int[] minLens = new int[BZ_N_GROUPS];

		@OriginalMember(owner = "client.client!sb", name = "V", descriptor = "I")
