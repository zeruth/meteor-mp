...
public class ObjType {
	...
	public static Pix32MapView getIcon(@OriginalArg(0) int id, @OriginalArg(2) int count) {
		@Pc(7) Pix32MapView icon = (Pix32MapView) iconCache.get(id);
		...
		icon = new Pix32MapView(32, 32);

		int _cx = Pix3DMapView.centerW3D;
		int _cy = Pix3DMapView.centerH3D;
		@Pc(80) int[] _loff = Pix3DMapView.lineOffset;
		@Pc(82) int[] _data = Pix2DMapView.data;
		@Pc(84) int _w = Pix2DMapView.width2d;
		@Pc(86) int _h = Pix2DMapView.height2d;
		@Pc(88) int _l = Pix2DMapView.boundLeft;
		@Pc(90) int _r = Pix2DMapView.boundRight;
		@Pc(92) int _t = Pix2DMapView.boundTop;
		@Pc(94) int _b = Pix2DMapView.boundBottom;

		Pix3DMapView.jagged = false;
		Pix2DMapView.bind(32, 32, icon.pixels);
		Pix2DMapView.fillRect(0, 0, 0, 32, 32);
		Pix3DMapView.init2D();

		@Pc(115) Model iModel = obj.getInterfaceModel(1);
		@Pc(125) int sinPitch = Pix3DMapView.sinTable[obj.xan2d] * obj.zoom2d >> 16;
		@Pc(135) int cosPitch = Pix3DMapView.cosTable[obj.xan2d] * obj.zoom2d >> 16;
		...
		if (obj.certtemplate != -1) {
			@Pc(348) Pix32MapView linkedIcon = getIcon(obj.certlink, 10);
		...
		Pix2DMapView.bind(_w, _h, _data);
		Pix2DMapView.setClipping(_b, _r, _t, _l);
		Pix3DMapView.centerW3D = _cx;
		Pix3DMapView.centerH3D = _cy;
		Pix3DMapView.lineOffset = _loff;
		Pix3DMapView.jagged = true;
		if (obj.stackable) {
			icon.cropW = 33;
		} else {
			icon.cropW = 32;
