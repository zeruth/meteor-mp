...
@OriginalClass("client.client!o")
public class TileUnderlay {

	@OriginalMember(owner = "client.client!o", name = "a", descriptor = "I")
	public final int southwestColor;

	@OriginalMember(owner = "client.client!o", name = "b", descriptor = "I")
	public final int southeastColor;

	@OriginalMember(owner = "client.client!o", name = "c", descriptor = "I")
	public final int northeastColor;

	@OriginalMember(owner = "client.client!o", name = "d", descriptor = "I")
	public final int northwestColor;

	@OriginalMember(owner = "client.client!o", name = "e", descriptor = "I")
	public final int textureId;

	@OriginalMember(owner = "client.client!o", name = "f", descriptor = "Z")
	public boolean flat = true;

	@OriginalMember(owner = "client.client!o", name = "g", descriptor = "I")
	public final int rgb;

	@OriginalMember(owner = "client.client!o", name = "<init>", descriptor = "(IIIIIIZ)V")
