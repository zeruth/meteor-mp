...
@OriginalClass("client.client!fb")
public class Pix2D extends DoublyLinkable {

	@OriginalMember(owner = "client.client!fb", name = "k", descriptor = "[I")
	public static int[] data;

	@OriginalMember(owner = "client.client!fb", name = "l", descriptor = "I")
	public static int width2d;

	@OriginalMember(owner = "client.client!fb", name = "m", descriptor = "I")
	public static int height2d;

	@OriginalMember(owner = "client.client!fb", name = "n", descriptor = "I")
	public static int boundTop;

	@OriginalMember(owner = "client.client!fb", name = "o", descriptor = "I")
	public static int boundBottom;

	@OriginalMember(owner = "client.client!fb", name = "p", descriptor = "I")
	public static int boundLeft;

	@OriginalMember(owner = "client.client!fb", name = "q", descriptor = "I")
	public static int boundRight;

	@OriginalMember(owner = "client.client!fb", name = "r", descriptor = "I")
	public static int safeWidth;

	@OriginalMember(owner = "client.client!fb", name = "s", descriptor = "I")
	public static int centerW2D;

	@OriginalMember(owner = "client.client!fb", name = "t", descriptor = "I")
	public static int centerH2D;

	@OriginalMember(owner = "client.client!fb", name = "<init>", descriptor = "()V")
	protected Pix2D() {
	}

	@OriginalMember(owner = "client.client!fb", name = "a", descriptor = "(I[III)V")
	...
	@OriginalMember(owner = "client.client!fb", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "client.client!fb", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "client.client!fb", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "client.client!fb", name = "a", descriptor = "(IIIBII)V")
	...
	@OriginalMember(owner = "client.client!fb", name = "a", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "client.client!fb", name = "b", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "client.client!fb", name = "c", descriptor = "(IIIII)V")
