...
public class Model extends DoublyLinkable {
	...
	public static int[] sinTable = Pix3DMapView.sinTable;

	@OriginalMember(owner = "client.client!eb", name = "Ob", descriptor = "[I")
	public static int[] cosTable = Pix3DMapView.cosTable;

	@OriginalMember(owner = "client.client!eb", name = "Pb", descriptor = "[I")
	public static int[] colourTable = Pix3DMapView.colourTable;

	@OriginalMember(owner = "client.client!eb", name = "Qb", descriptor = "[I")
	public static int[] divTable2 = Pix3DMapView.divTable2;
	...
	public void drawSimple(@OriginalArg(0) int pitch, @OriginalArg(1) int yaw, @OriginalArg(2) int roll, @OriginalArg(3) int eyePitch, @OriginalArg(4) int eyeX, @OriginalArg(5) int eyeY, @OriginalArg(6) int eyeZ) {
		@Pc(1) int centerX = Pix3DMapView.centerW3D;
		@Pc(3) int centerY = Pix3DMapView.centerH3D;
	...
	public void draw(@OriginalArg(0) int yaw, @OriginalArg(1) int sinEyePitch, @OriginalArg(2) int cosEyePitch, @OriginalArg(3) int sinEyeYaw, @OriginalArg(4) int cosEyeYaw, @OriginalArg(5) int relativeX, @OriginalArg(6) int relativeY, @OriginalArg(7) int relativeZ, @OriginalArg(8) int bitset) {
		...
		if (leftX / maxZ >= Pix2DMapView.centerW2D) {
			return;
		}

		@Pc(69) int rightX = midX + this.radius << 9;
		if (rightX / maxZ <= -Pix2DMapView.centerW2D) {
			return;
		}
		...
		if (bitset > 0 && checkHover) {
			...
			int mouseX = Model.mouseX - Pix3DMapView.centerW3D;
			int mouseY = mouseZ - Pix3DMapView.centerH3D;
		...
		int centerX = Pix3DMapView.centerW3D;
		int centerY = Pix3DMapView.centerH3D;
			...
			if (this.faceInfos == null || this.faceInfos[f] != -1) {
				...
				if (clipped && (xA == -5000 || xB == -5000 || xC == -5000)) {
					...
					if ((xA - xB) * (vertexScreenY[c] - vertexScreenY[b]) - (vertexScreenY[a] - vertexScreenY[b]) * (xC - xB) > 0) {
						...
						faceClippedX[f] = xA < 0 || xB < 0 || xC < 0 || xA > Pix2DMapView.safeWidth || xB > Pix2DMapView.safeWidth || xC > Pix2DMapView.safeWidth;
						int depthAverage = (vertexScreenZ[a] + vertexScreenZ[b] + vertexScreenZ[c]) / 3 + this.minDepth;
						tmpDepthFaces[depthAverage][tmpDepthFaceCount[depthAverage]++] = f;
					}
				}
	...
	private void drawFace(@OriginalArg(0) int face) {
		...
		Pix3DMapView.hclip = faceClippedX[face];

		if (this.faceAlphas == null) {
			Pix3DMapView.trans = 0;
		} else {
			Pix3DMapView.trans = this.faceAlphas[face];
		}
		...
		if (type == 0) {
			Pix3DMapView.gouraudTriangle(vertexScreenX[a], vertexScreenX[b], vertexScreenX[c], vertexScreenY[a], vertexScreenY[b], vertexScreenY[c], this.faceColorA[face], this.faceColorB[face], this.faceColorC[face]);
		} else if (type == 1) {
			Pix3DMapView.flatTriangle(vertexScreenX[a], vertexScreenX[b], vertexScreenX[c], vertexScreenY[a], vertexScreenY[b], vertexScreenY[c], colourTable[this.faceColorA[face]]);
		} else if (type == 2) {
	...
	private void drawNearClippedFace(@OriginalArg(0) int face) {
		@Pc(3) int centerX = Pix3DMapView.centerW3D;
		@Pc(5) int centerY = Pix3DMapView.centerH3D;
		@Pc(7) int elements = 0;
		...
		Pix3DMapView.hclip = false;

		if (elements == 3) {
			if (x0 < 0 || x1 < 0 || x2 < 0 || x0 > Pix2DMapView.safeWidth || x1 > Pix2DMapView.safeWidth || x2 > Pix2DMapView.safeWidth) {
				Pix3DMapView.hclip = true;
			}
			...
			if (type == 0) {
				Pix3DMapView.gouraudTriangle(x0, x1, x2, y0, y1, y2, clippedColor[0], clippedColor[1], clippedColor[2]);
			} else if (type == 1) {
				Pix3DMapView.flatTriangle(x0, x1, x2, y0, y1, y2, colourTable[this.faceColorA[face]]);
			} else if (type == 2) {
				int texturedFace = this.faceInfos[face] >> 2;
				int tA = this.texturePCoordinate[texturedFace];
				int tB = this.textureMCoordinate[texturedFace];
				int tC = this.textureNCoordinate[texturedFace];
				Pix3DMapView.textureTriangle(x0, x1, x2, y0, y1, y2, clippedColor[0], clippedColor[1], clippedColor[2], vertexViewSpaceX[tA], vertexViewSpaceY[tA], vertexViewSpaceZ[tA], vertexViewSpaceX[tB], vertexViewSpaceX[tC], vertexViewSpaceY[tB], vertexViewSpaceY[tC], vertexViewSpaceZ[tB], vertexViewSpaceZ[tC], this.faceColors[face]);
			} else if (type == 3) {
				int texturedFace = this.faceInfos[face] >> 2;
				int tA = this.texturePCoordinate[texturedFace];
				int tB = this.textureMCoordinate[texturedFace];
				int tC = this.textureNCoordinate[texturedFace];
				Pix3DMapView.textureTriangle(x0, x1, x2, y0, y1, y2, this.faceColorA[face], this.faceColorA[face], this.faceColorA[face], vertexViewSpaceX[tA], vertexViewSpaceY[tA], vertexViewSpaceZ[tA], vertexViewSpaceX[tB], vertexViewSpaceX[tC], vertexViewSpaceY[tB], vertexViewSpaceY[tC], vertexViewSpaceZ[tB], vertexViewSpaceZ[tC], this.faceColors[face]);
			}
		} else if (elements == 4) {
			if (x0 < 0 || x1 < 0 || x2 < 0 || x0 > Pix2DMapView.safeWidth || x1 > Pix2DMapView.safeWidth || x2 > Pix2DMapView.safeWidth || clippedX[3] < 0 || clippedX[3] > Pix2DMapView.safeWidth) {
				Pix3DMapView.hclip = true;
			}
			...
			if (type == 0) {
				Pix3DMapView.gouraudTriangle(x0, x1, x2, y0, y1, y2, clippedColor[0], clippedColor[1], clippedColor[2]);
				Pix3DMapView.gouraudTriangle(x0, x2, clippedX[3], y0, y2, clippedY[3], clippedColor[0], clippedColor[2], clippedColor[3]);
			} else if (type == 1) {
				int colorA = colourTable[this.faceColorA[face]];
				Pix3DMapView.flatTriangle(x0, x1, x2, y0, y1, y2, colorA);
				Pix3DMapView.flatTriangle(x0, x2, clippedX[3], y0, y2, clippedY[3], colorA);
			} else if (type == 2) {
				int texturedFace = this.faceInfos[face] >> 2;
				int tA = this.texturePCoordinate[texturedFace];
				int tB = this.textureMCoordinate[texturedFace];
				int tC = this.textureNCoordinate[texturedFace];
				Pix3DMapView.textureTriangle(x0, x1, x2, y0, y1, y2, clippedColor[0], clippedColor[1], clippedColor[2], vertexViewSpaceX[tA], vertexViewSpaceY[tA], vertexViewSpaceZ[tA], vertexViewSpaceX[tB], vertexViewSpaceX[tC], vertexViewSpaceY[tB], vertexViewSpaceY[tC], vertexViewSpaceZ[tB], vertexViewSpaceZ[tC], this.faceColors[face]);
				Pix3DMapView.textureTriangle(x0, x2, clippedX[3], y0, y2, clippedY[3], clippedColor[0], clippedColor[2], clippedColor[3], vertexViewSpaceX[tA], vertexViewSpaceY[tA], vertexViewSpaceZ[tA], vertexViewSpaceX[tB], vertexViewSpaceX[tC], vertexViewSpaceY[tB], vertexViewSpaceY[tC], vertexViewSpaceZ[tB], vertexViewSpaceZ[tC], this.faceColors[face]);
			} else if (type == 3) {
				int texturedFace = this.faceInfos[face] >> 2;
				int tA = this.texturePCoordinate[texturedFace];
				int tB = this.textureMCoordinate[texturedFace];
				int tC = this.textureNCoordinate[texturedFace];
				Pix3DMapView.textureTriangle(x0, x1, x2, y0, y1, y2, this.faceColorA[face], this.faceColorA[face], this.faceColorA[face], vertexViewSpaceX[tA], vertexViewSpaceY[tA], vertexViewSpaceZ[tA], vertexViewSpaceX[tB], vertexViewSpaceX[tC], vertexViewSpaceY[tB], vertexViewSpaceY[tC], vertexViewSpaceZ[tB], vertexViewSpaceZ[tC], this.faceColors[face]);
				Pix3DMapView.textureTriangle(x0, x2, clippedX[3], y0, y2, clippedY[3], this.faceColorA[face], this.faceColorA[face], this.faceColorA[face], vertexViewSpaceX[tA], vertexViewSpaceY[tA], vertexViewSpaceZ[tA], vertexViewSpaceX[tB], vertexViewSpaceX[tC], vertexViewSpaceY[tB], vertexViewSpaceY[tC], vertexViewSpaceZ[tB], vertexViewSpaceZ[tC], this.faceColors[face]);
			}
		}
	}
